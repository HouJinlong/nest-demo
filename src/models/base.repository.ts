...
export abstract class BaseRepository<T extends BaseModel> {
     ...
     * @returns {QueryList<T>}
     */
    public findAll(conditions: any, projection?: any, options: {
        sort?: OrderType<T>;
        limit?: number;
        skip?: number;
        lean?: boolean;
    ...
    public async findAllAsync(conditions: any, projection?: any, options: {
        sort?: OrderType<T>;
        limit?: number;
        skip?: number;
        lean?: boolean;
        ...
        try {
            return this.populates<Array<DocumentType<T>>>(docsQuery, populates);
        } catch (e) {
     ...
     */
    public async paginator(conditions: PaginationParams<T>, projection?: any, options: {
        lean?: boolean;
        populates?: ModelPopulateOptions[] | ModelPopulateOptions;
        [key: string]: any;
    } = {}): Promise<Paginator<T>> {
     ...
     * @returns {QueryItem<T>}
     */
    public findOne(conditions: any, projection?: any, options: {
        lean?: boolean;
        populates?: ModelPopulateOptions[] | ModelPopulateOptions;
        [key: string]: any;
    } = {}): QueryItem<T> {
    ...
    public findOneAsync(conditions: any, projection?: any, options: {
        lean?: boolean;
        populates?: ModelPopulateOptions[] | ModelPopulateOptions;
        [key: string]: any;
    } = {}): Promise<T | null> {
     ...
     * @returns {QueryItem<T>}
     */
    public findById(id: string, projection?: any, options: {
        lean?: boolean;
        populates?: ModelPopulateOptions[] | ModelPopulateOptions;
        [key: string]: any;
    } = {}): QueryItem<T> {
    ...
    public findByIdAsync(id: string, projection?: any, options: {
        lean?: boolean;
        populates?: ModelPopulateOptions[] | ModelPopulateOptions;
        [key: string]: any;
    } = {}): Promise<T | null> {
     ...
     */
    public async create(docs:CreateQuery<Partial<T>>): Promise<DocumentType<T>> {
        try {
     ...
     * @returns {QueryItem<T>}
     */
    public update(id: string, update:any, options: QueryFindOneAndUpdateOptions = { new: true }): QueryItem<T> {
     ...
     */
    public clearCollection(conditions: any = {}): Promise<WriteOpResult['result']> {
        try {
     ...
     */
    private populates<D>(
        docsQuery: DocumentQuery<D, DocumentType<T>, unknown>,
        populates: ModelPopulateOptions | ModelPopulateOptions[] | null): DocumentQuery<D, DocumentType<T>, unknown> {
        if (populates) {
